	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'parents-christmas':
				...
				//THESE CHARACTERS ARE FROM SHITBOX!!
				case 'gf-sonic':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('characters/shitbox/lookatemgo');
				frames = tex;
				...
				#if !OPTIMIZE
				{
				var tex = Paths.getSparrowAtlas('characters/shitbox/Jamey','shared');
				frames = tex;
				}
				#else
        {
        var tex = Paths.getSparrowAtlas('opti_characters/shitbox/Jamey','shared');
        frames = tex;
        }
        #end
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
        ...
        animation.addByPrefix('singLEFT', 'Right', 8, false);
				...
				tex = Paths.getSparrowAtlas('characters/shitbox/Hank_assets', 'shared');
				frames = tex;
        ...
        animation.addByPrefix('singLEFT', 'Right', 8, false);
				...
				#if !OPTIMIZE
        {
				tex = Paths.getSparrowAtlas('characters/shitbox/SonicAssets', 'shared');
				frames = tex;
        }
        #else
        {
        var tex = Paths.getSparrowAtlas('opti_characters/shitbox/SonicAssets','shared');
        frames = tex;
        }
        #end
			...
			#if !OPTIMIZE
			{
				var tex = Paths.getSparrowAtlas('characters/shitbox/soulbf','shared');
				frames = tex;
			}
			#else
      {
      var tex = Paths.getSparrowAtlas('opti_characters/shitbox/soulbf','shared');
      frames = tex;
      }
      #end
			...
			#if !OPTIMIZE
			{
				var tex = Paths.getSparrowAtlas('characters/shitbox/144p','shared');
				frames = tex;
			}
			#else
      {
      var tex = Paths.getSparrowAtlas('opti_characters/shitbox/144p','shared');
      frames = tex;
      }
      #end
			...
			#if !OPTIMIZE
			{
				var tex = Paths.getSparrowAtlas('characters/shitbox/nyan','shared');
				frames = tex;
			}
			#else
      {
      var tex = Paths.getSparrowAtlas('opti_characters/shitbox/nyan','shared');
      frames = tex;
      }
      #end
